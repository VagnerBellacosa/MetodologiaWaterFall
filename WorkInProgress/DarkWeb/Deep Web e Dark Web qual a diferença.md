...
*OBS:
Algumas divergem um pouco sobre a presença de nomes como [Facebook](https://tecnoblog.net/sobre/meta/facebook/) na Surface Web.*

![darkwebnews](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20700%20760'%3E%3C/svg%3E)

Evidente que, embora não indexáveis, você pode acessar sites que exigem [login](https://tecnoblog.net/responde/o-que-e-login/) usando seu navegador de internet comum. Entretanto, se você pretender não ter o seu [acesso a eles rastreado,](https://tecnoblog.net/noticias/2014/07/31/tor-anonimato-risco/) vai precisar usar um rede de proteção, como o Tor (um software livre e de código aberto que oferece comunicação segura ao navegar na Internet). Esse tipo de navegador, além de proteger, também permite acessar o que não está na superfície.

Quem [acessa a Deep Web através de softwares específicos](https://tecnoblog.net/responde/como-acessar-deep-web-links/) **não necessariamente deseja cometer crimes.** Mas, no geral, esse indivíduo **não quer ser rastreado**, e muito menos que seu trabalho seja indexado na Surface Web. Isso vale tanto para agências governamentais, quanto para administradores de dados de gigantes tecnológicas, jornalistas, ativistas ou qualquer pessoa que corra algum risco em se expor online.
...
![HJacker / crime / Deep Web](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20700%20394'%3E%3C/svg%3E)
...
[![WhatsApp Web tem modo escuro que pode ser ativado no navegador](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)WhatsApp Web tem modo escuro que pode ser ativado no navegadorWhatsApp Web possui modo escuro "oculto" no código da página no navegador; saiba como ativar no Google Chrome e Firefox](https://tecnoblog.net/noticias/2020/05/18/whatsapp-web-tem-modo-escuro-que-pode-ser-ativado-no-navegador/)[![WhatsApp prepara modo escuro para versões web e desktop](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)WhatsApp prepara modo escuro para versões web e desktopHá referências ao modo escuro no código do WhatsApp Web e Desktop; app beta para iPhone e para Android tem dark mode](https://tecnoblog.net/noticias/2020/02/26/whatsapp-prepara-modo-escuro-para-versoes-web-desktop/)[![Facebook tira “notícias” do feed de notícias, 1ª mudança em 15 anos](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)Facebook tira “notícias” do feed de notícias, 1ª mudança em 15 anosApós mais de 15 anos, o Facebook vai remover a nomenclatura "notícias" de sua página para deixar apenas o nome "Feed"](https://tecnoblog.net/noticias/2022/02/16/facebook-tira-noticias-do-feed-de-noticias-1a-mudanca-em-15-anos/)[![Windows 11, dados vazados, problemas com Uber e mais: a tecnologia em 2021](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)Windows 11, dados vazados, problemas com Uber e mais: a tecnologia em 2021De uma enorme onda de ataques hacker a um apagão de serviços do Facebook: relembre os principais acontecimentos tecnológicos de 2021](https://tecnoblog.net/especiais/ana-marques/windows-11-dados-vazados-problemas-com-uber-e-mais-a-tecnologia-em-2021/)[![Mulher é condenada por tentar contratar assassino de aluguel pela internet](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E)Mulher é condenada por tentar contratar assassino de aluguel pela internetUma mulher de 52 anos tentou contratar um assassino de aluguel através de um site criado como uma brincadeira; ela foi condenada](https://tecnoblog.net/noticias/2021/11/25/mulher-e-condenada-por-tentar-contratar-assassino-de-aluguel-pela-internet/)

[Como sincronizar o iPhone com o iTunes](https://tecnoblog.net/responde/como-sincronizar-o-iphone-com-o-itunes/)[Como encontrar pessoas no Google Hangouts (adicionar contatos)](https://tecnoblog.net/responde/como-encontrar-pessoas-no-google-hangouts/)
